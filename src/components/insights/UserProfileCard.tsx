      ...
      <View className="flex-row bg-card gap-4 border border-border items-center justify-between p-4 rounded-3xl">
         <View className="flex-row gap-4 items-center">
            ...
            <View className="flex gap-1">
               <Text className="text-xs tracking-widest text-muted-foreground uppercase">Signed in as</Text>
               <Text className="font-bold text-xl text-foreground">{user.fullName}</Text>
